# eastern_canada_zebra_mussels

This repository contains scripts and data used for the publication "Zebra mussels (Dreissena polymorpha) on the move: Recent detections in Quebec and New Brunswick and implications for spread in eastern Canada" (Weise et al 2026). 

It includes:

- Scripts used to generate figures for the article (including those in Supplementary material).
- Scripts used to generate summary statistics used in the article tables and text.

- Zebra mussel density data for benthic sites in Lake Témiscouata (2022 to 2024)
- Zebra mussel density data on plant stems sampled in Lake Témiscouata (2022 to 2023)
- Zebra mussel veliger data from Lake Témiscouata and the Madawaska River (2023)
